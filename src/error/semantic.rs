...
pub enum SemanticError {
    ...
    PropertyDoesNotExistOnUnion(usize, usize, usize, String, Type, Type),
            ...
            SemanticError::ArityMismatch(line, starts_at, ends_at, expected, found) => static_error_template(
                ...
                SemanticError::PropertyDoesNotExist(line, starts_at, ends_at, field, type_) => static_error_template(
                    ...
                    *line,
                    ...
                    Some(print_marker(*starts_at, *ends_at, None))),
                SemanticError::PropertyDoesNotExistOnUnion(line, starts_at, ends_at, field, type_a, type_b) => static_error_template(
                    error_type,
                    source_vec,
                    *line,
                    Some(*starts_at),
                    Some(*ends_at),
                    format!("Property \"{}\" does not exist in type \"{}\" from union \"{}\"", field, type_a, type_b),
                    Some(print_marker(*starts_at, *ends_at, None))),
